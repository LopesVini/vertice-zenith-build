...
import { Loader2, LogOut, LayoutDashboard, Box, History, MoreVertical, User, Settings, UserCircle, Sun, Moon } from "lucide-react";
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-navy-dark text-navy dark:text-white flex transition-colors duration-300">
      ...
      <aside className="w-20 lg:w-64 border-r border-zinc-200 dark:border-white/5 bg-white/50 dark:bg-navy/20 flex flex-col h-screen sticky top-0 backdrop-blur-xl z-40 transition-all duration-300">
        <div className="h-20 flex items-center justify-center lg:justify-start lg:px-8 border-b border-zinc-200 dark:border-white/5">
          <div className="w-8 h-8 bg-primary rounded-lg shadow-lg dark:shadow-[0_0_15px_rgba(var(--primary),0.5)]" />
        ...
        <div className="mt-auto flex flex-col">
          ...
          {/* User Profile Widget */}
          <div className="p-4 flex items-center justify-between hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer transition-colors group">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-md bg-white dark:bg-navy-dark border border-zinc-200 dark:border-white/10 flex items-center justify-center overflow-hidden">
                <User className="w-5 h-5 text-zinc-400 group-hover:text-primary transition-colors" />
              </div>
              <div className="hidden lg:block">
                <p className="text-sm font-bold font-sans tracking-tight text-navy dark:text-white leading-tight">
                  {session.user.email?.split("@")[0].toUpperCase() || "CLIENTE"}
                </p>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="hidden lg:block text-zinc-500 hover:text-white transition-colors outline-none">
              ...
              <DropdownMenuContent align="end" className="w-56 bg-white dark:bg-navy border-zinc-200 dark:border-white/10 text-navy dark:text-white rounded-xl shadow-2xl">
                ...
                <DropdownMenuItem className="cursor-pointer hover:bg-black/5 dark:hover:bg-white/10 focus:bg-black/5 dark:focus:bg-white/10">
